...
class QNdefNfcSmartPoster;

class Q_NFC_EXPORT QNdefNfcSmartPosterRecord : public QNdefRecord
{
public:
    Q_DECLARE_NDEF_RECORD(QNdefNfcSmartPosterRecord, QNdefRecord::NfcRtd, "Sp",
                          QByteArray("\xd1\x01\x01\x55\x00", 5))

    QNdefNfcSmartPoster smartPoster() const;
    void setSmartPoster(const QNdefNfcSmartPoster &poster);
};
